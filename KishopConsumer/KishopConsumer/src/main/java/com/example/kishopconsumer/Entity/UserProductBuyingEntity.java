...
public class UserProductBuyingEntity {
    ...
    public UserProductBuyingEntity(Date date, String product_name,String price, String productImage,String type, String status, double amount, UserBuyingEntity userBuyingEntity) {
        this.date = date;
